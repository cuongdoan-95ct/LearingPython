...
* Tập trung vào hai khía cạnh chính để đảm bảo API của bạn dễ sử dụng: **tổ chức API** và **kích thước API**.
...
### Mỗi khía cạnh của API, bao gồm dữ liệu và mục tiêu, nên được định kích thước một cách khôn ngoan.
