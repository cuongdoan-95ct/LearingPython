...
Tập trung vào việc thiết kế API từ góc độ của người dùng API.
Mục tiêu chính là tạo ra các API dễ hiểu và dễ sử dụng.
...
Điều này đúng với cả API: tập trung vào cách phần mềm hoạt động sẽ dẫn đến thảm họa,
tập trung vào những gì người dùng có thể làm sẽ giúp mọi thứ diễn ra suôn sẻ.
...
API là những gì người dùng nhìn thấy
    một biểu diễn của những gì họ có thể làm.
...
Độ phức tạp hay đơn giản của API phụ thuộc vào
góc nhìn bạn tập trung khi thiết kế.
API phải được thiết kế từ góc nhìn của người tiêu dùng,
không phải của nhà cung cấp.

## Xác định Mục tiêu của API (Identifying an API’s Goals)
Bước đầu tiên và quan trọng nhất là xác định
các mục tiêu thực sự của API.
...
-Góc nhìn nhà cung cấp là không thể tránh khỏi
và có thể xuất hiện ở mọi giai đoạn thiết kế.

-Biểu hiện qua việc phơi bày các khía cạnh
không phải là việc của người tiêu dùng:
...
-Tất cả các khía cạnh này đều liên quan đến việc phơi bày
những gì không phải là việc của người tiêu dùng.

-Phát hiện trong API Goals Canvas: Thêm câu hỏi:
"Tất cả những điều này có thực sự là việc của người tiêu dùng không?".
